...
public class Word {
   ...
   [JsonPropertyName("simple_meaning")]
   public string SimpleMeaning { get; set; } = "";

   [JsonPropertyName("full_meaning")]
   public string FullMeaning { get; set; } = "";

   [JsonPropertyName("modifiable_types")]
   public List<string>? ModifiableTypes { get; set; }

   [JsonPropertyName("attachment_types")]
   public List<string>? AttachmentTypes { get; set; }

   [JsonPropertyName("attachment_notes")]
   public List<string?>? AttachmentNotes { get; set; }

   [JsonPropertyName("formatted_meaning")]
   public string? FormattedMeaning { get; set; }
}